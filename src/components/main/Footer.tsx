    ...
    <footer className="py-6 md:py-10 border-t">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between gap-6">
        <div className="flex flex-col gap-2">
          <Link className="flex items-center gap-2" href="/" data-discover="true">
            <div className="font-bold text-xl tracking-tight text-primary flex items-center gap-2">
          <div className="bg-blue-600 p-1 rounded">
            <UserRoundCogIcon size={20} className="text-primary-foreground" />
          </div>
          EMSxpert
        </div>
          </Link>
      ...
      <div className="container px-4 mt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-muted-foreground">
        <p>© {new Date().getFullYear()} EMSXpert. All rights reserved.</p>
        <div className="flex items-center gap-4 mt-4 sm:mt-0">
          <a className="hover:text-foreground" href="/" data-discover="true">
            <svg
              width="20"
              height="20"
              fill="currentColor"
